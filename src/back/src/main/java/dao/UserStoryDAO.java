...
public interface UserStoryDAO {
    ...
    List<UserStory> getByPriority(int project_id, String priority) throws SQLException;
    List<UserStory> getByDifficulty(int project_id, int difficulty) throws SQLException;
}
